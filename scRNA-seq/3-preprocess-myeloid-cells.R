...
save(Clusters, file = file.path(datafolder, "Clusters2_integrated_mito5.Rdata"))
...
write.xlsx(All.markers_norm, file = file.path(outfolder, "FindAllMarkers", "All.markers_Clusters2_Integration_mito5.xlsx"))
saveRDS(All.markers_norm, file = file.path(datafolder, "FindAllMarkers", "All.markers_Clusters2_Integration_mito5.rds"))
