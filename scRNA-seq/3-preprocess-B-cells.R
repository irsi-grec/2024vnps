...
save(Clusters, file = file.path(datafolder, "Clusters1_integrated_mito5.Rdata"))
...
write.xlsx(All.markers_norm, file = file.path(outfolder, "FindAllMarkers", "All.markers_Clusters1_Integration_mito5.xlsx"))
saveRDS(All.markers_norm, file = file.path(outfolder, "FindAllMarkers", "All.markers_Clusters1_Integration_mito5.rds"))