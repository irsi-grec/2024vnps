...
save(Clusters, file = file.path(datafolder, "Clusters3_CD4_integrated_mito5.Rdata"))
...
write.xlsx(All.markers_norm, file = file.path(outfolder, "FindAllMarkers", "All.markers_Clusters3_CD4_Integration_mito5.xlsx"))
saveRDS(All.markers_norm, file = file.path(datafolder, "FindAllMarkers", "All.markers_Clusters3_CD4_Integration_mito5.rds"))
